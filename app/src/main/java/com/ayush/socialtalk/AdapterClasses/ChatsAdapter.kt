...
import com.ayush.socialtalk.ViewFull_ImageActivity
import com.ayush.socialtalk.WelcomeActivity
...
) : RecyclerView.Adapter<ChatsAdapter.ViewHolder?>()
{
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int)
    {
        ...
        //Differentiate between the text Message and  Image File
        // 1. messages ,images
        if (chat.getMessage().equals("sent you an image.") && !chat.getUrl().equals(""))
        {
            //image message -- right -side
            if (chat.getSender().equals(firbaseUser!!.uid))
            {
                ...
                holder.right_image_view!!.setOnClickListener {
                    ...
                    builder.setItems(options,DialogInterface.OnClickListener{
                        ...
                        if (which == 0)
                        {
                            val intent  = Intent(mContext, ViewFull_ImageActivity::class.java)
            ...
            else if (!chat.getSender().equals(firbaseUser!!.uid))
            {
                holder.show_text_message!!.visibility = View.GONE
        ...
        else
        {
            ...
            if (firbaseUser!!.uid == chat.getSender())
            {
    ...
    override fun getItemViewType(position: Int): Int
    {
        ...
        return  if (mChatList[position].getSender().equals(firbaseUser!!.uid))
        {
            1
        }
        else
    ...
    private fun deleteSentMessage(position: Int, holder: ChatsAdapter.ViewHolder)
    {
        val ref = FirebaseDatabase.getInstance().reference.child("Chats")
            ...
            .addOnCompleteListener{task ->
                ...
                {
                    Toast.makeText(holder.itemView.context,"Failed to Deleted",Toast.LENGTH_SHORT).show()
                }
            }
    }
}